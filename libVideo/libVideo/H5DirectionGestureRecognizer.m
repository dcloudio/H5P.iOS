...
@interface H5UIDirectionGestureRecognizer()
@property(nonatomic, weak)id<NSObject> directionTarget;
@property(nonatomic, copy)NSString* directionSelectorString;
@property(nonatomic, assign)H5UIDirectionGestureRecognizerDirection direction;
...
@implementation H5UIDirectionGestureRecognizer
