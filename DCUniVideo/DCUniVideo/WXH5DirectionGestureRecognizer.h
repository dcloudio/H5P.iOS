...
typedef NS_OPTIONS(NSUInteger, WXH5UIDirectionGestureRecognizerDirection) {
...
@interface WXH5UIDirectionGestureRecognizer : UIPanGestureRecognizer
@property(nonatomic, readonly)WXH5UIDirectionGestureRecognizerDirection direction;
