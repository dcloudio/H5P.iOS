...
@interface WXH5VideoBrightnessView()
...
@implementation WXH5VideoBrightnessView

+ (instancetype)sharedView {
    static WXH5VideoBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[WXH5VideoBrightnessView alloc] init];
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.backImage.image = [UIImage imageNamed:@"control_brightness"];
