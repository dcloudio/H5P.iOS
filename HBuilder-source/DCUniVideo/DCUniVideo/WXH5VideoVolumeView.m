...
@implementation WXH5VideoVolumeView

+ (instancetype)sharedView{
    static WXH5VideoVolumeView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[WXH5VideoVolumeView alloc] init];
...
- (void)dealloc {
    [[UIScreen mainScreen] removeObserver:self forKeyPath:@"volume"];
