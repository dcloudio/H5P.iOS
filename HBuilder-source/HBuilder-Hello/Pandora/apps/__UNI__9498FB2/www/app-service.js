...
var x=['./components/page-head.wxml'];d_[x[0]]={}
...
__wxAppCode__['app.json']={"pages":[],"window":{"navigationBarTextStyle":"white","navigationBarBackgroundColor":"#007AFF","backgroundColor":"#F8F8F8"},"tabBar":{"color":"#7A7E83","selectedColor":"#007AFF","borderStyle":"black","backgroundColor":"#F8F8F8","list":[{"pagePath":"pages/tabBar/fe","iconPath":"static/fe.png","selectedIconPath":"static/feHL.png","text":"前端组件"},{"pagePath":"pages/tabBar/native","iconPath":"static/native.png","selectedIconPath":"static/nativeHL.png","text":"原生组件"}]},"nvue":{"pages":{"pages/tabBar/fe.html":{"window":{"usingComponents":{},"navigationBarTitleText":"NVUE前端组件"},"nvue":true},"pages/tabBar/native.html":{"window":{"usingComponents":{},"navigationBarTitleText":"NVUE原生组件"},"nvue":true},"native/barcode/barcode.html":{"window":{"usingComponents":{},"navigationBarTitleText":"barcode","enablePullDownRefresh":true,"titleNView":false,"bounce":"none","pullToRefresh":{"support":true,"color":"#ed4b13","style":"circle"}},"nvue":true},"pages/fe/button/button.html":{"window":{"usingComponents":{},"navigationBarTitleText":"button","subNVues":[{"id":"concat","path":"pages/fe/checkbox/checkbox","type":"popup","style":{"position":"absolute","dock":"right","width":"160upx","height":"60upx","backgroundColor":"","bottom":"111px"}}]},"nvue":true},"pages/fe/checkbox/checkbox.html":{"window":{"usingComponents":{},"navigationBarTitleText":"checkbox"},"nvue":true},"pages/fe/radio/radio.html":{"window":{"usingComponents":{},"navigationBarTitleText":"radio"},"nvue":true},"pages/fe/label/label.html":{"window":{"usingComponents":{},"navigationBarTitleText":"label"},"nvue":true},"pages/fe/form/form.html":{"window":{"usingComponents":{},"navigationBarTitleText":"form"},"nvue":true},"pages/fe/movable-view/movable-view.html":{"window":{"usingComponents":{},"navigationBarTitleText":"movable-view"},"nvue":true},"pages/fe/swiper/swiper.html":{"window":{"usingComponents":{},"navigationBarTitleText":"swiper"},"nvue":true},"pages/fe/swiper-vertical/swiper-vertical.html":{"window":{"usingComponents":{},"navigationBarTitleText":"swiper-vertical","titleNView":false},"nvue":true},"pages/fe/scroll-view/scroll-view.html":{"window":{"usingComponents":{},"navigationBarTitleText":"scroll-view"},"nvue":true},"pages/fe/switch/switch.html":{"window":{"usingComponents":{},"navigationBarTitleText":"switch"},"nvue":true},"pages/fe/slider/slider.html":{"window":{"usingComponents":{},"navigationBarTitleText":"slider"},"nvue":true},"pages/fe/progress/progress.html":{"window":{"usingComponents":{},"navigationBarTitleText":"progress"},"nvue":true},"pages/fe/navigator/index.html":{"window":{"usingComponents":{},"navigationBarTitleText":"navigator"},"nvue":true},"pages/fe/navigator/navigate.html":{"window":{"usingComponents":{},"navigationBarTitleText":"navigate"},"nvue":true},"pages/fe/navigator/redirect.html":{"window":{"usingComponents":{},"navigationBarTitleText":"redirect"},"nvue":true},"native/canvas/canvas.html":{"window":{"usingComponents":{},"navigationBarTitleText":"canvas"},"nvue":true},"native/canvas/webGL.html":{"window":{"usingComponents":{},"navigationBarTitleText":"webGL"},"nvue":true},"native/canvas/animation.html":{"window":{"usingComponents":{},"navigationBarTitleText":"Animation"},"nvue":true},"native/cover-image/cover-image.html":{"window":{"usingComponents":{},"navigationBarTitleText":"cover-image"},"nvue":true},"native/cover-view/cover-view.html":{"window":{"usingComponents":{},"navigationBarTitleText":"cover-view"},"nvue":true},"native/live-pusher/live-pusher.html":{"window":{"usingComponents":{},"navigationBarTitleText":"live-pusher","titleNView":{"type":"transparent","titleText":"livessss","Buttons":[{"type":"favorite","background":"rgba(0,0,0,0)","onclick":"javascript:clickedButton()"}]}},"nvue":true},"native/map/map.html":{"window":{"usingComponents":{},"navigationBarTitleText":"map"},"nvue":true},"native/map/mapsearch.html":{"window":{"usingComponents":{},"navigationBarTitleText":"mapSearch"},"nvue":true},"native/video/video.html":{"window":{"usingComponents":{},"navigationBarTitleText":"video"},"nvue":true},"native/faceID/faceID.html":{"window":{"usingComponents":{},"navigationBarTitleText":"faceID"},"nvue":true},"native/u-image/u-image.html":{"window":{"usingComponents":{},"navigationBarTitleText":"u-image"},"nvue":true},"native/u-input/u-input.html":{"window":{"usingComponents":{},"navigationBarTitleText":"u-input"},"nvue":true},"native/u-richtext/u-richtext.html":{"window":{"usingComponents":{},"navigationBarTitleText":"u-richtext"},"nvue":true},"native/u-text/u-text.html":{"window":{"usingComponents":{},"navigationBarTitleText":"u-text"},"nvue":true},"native/u-textarea/u-textarea.html":{"window":{"usingComponents":{},"navigationBarTitleText":"u-textarea"},"nvue":true},"native/u-webview/u-webview.html":{"window":{"usingComponents":{},"navigationBarTitleText":"u-webview"},"nvue":true},"native/webSocket/webSocket.html":{"window":{"usingComponents":{},"navigationBarTitleText":"webSocket"},"nvue":true},"pages/fe/lifecycle/lifecycle.html":{"window":{"usingComponents":{},"navigationBarTitleText":"生命周期","enablePullDownRefresh":true,"titleNView":{"buttons":[{"text":"测"}]}},"nvue":true},"pages/fe/global/global.html":{"window":{"usingComponents":{},"navigationBarTitleText":"全局变量和vuex"},"nvue":true}},"entryPagePath":"pages/tabBar/fe"},"nvueCompiler":"uni-app","renderer":"auto","splashscreen":{"alwaysShowBeforeRender":true,"autoclose":false},"appname":"HelloNVUE","compilerVersion":"2.3.5","usingComponents":{"page-head":"/components/page-head"}};
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["common/main"],{"0136":function(e,t,n){"use strict";n.r(t);var o=n("0e32"),u=n.n(o);for(var a in o)"default"!==a&&function(e){n.d(t,e,function(){return o[e]})}(a);t["default"]=u.a},"086e":function(e,t,n){"use strict";(function(e){n("8f5f"),n("921b");var t=a(n("66fd")),o=a(n("3f21")),u=a(n("1b6d"));function a(e){return e&&e.__esModule?e:{default:e}}function c(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{},o=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(o=o.concat(Object.getOwnPropertySymbols(n).filter(function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable}))),o.forEach(function(t){r(e,t,n[t])})}return e}function r(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var l=function(){return n.e("components/page-head").then(n.bind(null,"96e2"))};t.default.config.productionTip=!1,t.default.prototype.$store=u.default,t.default.component("page-head",l),o.default.mpType="app";var f=new t.default(c({store:u.default},o.default));e(f).$mount()}).call(this,n("6e42")["createApp"])},"0e32":function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n={onLaunch:function(){console.log(e("App Launch"," at App.vue:4"))},onShow:function(){console.log(e("App Show"," at App.vue:14"))},onHide:function(){console.log(e("App Hide"," at App.vue:17"))},globalData:{text:"全局globalData中text的值"}};t.default=n}).call(this,n("0de9")["default"])},"1a8c":function(e,t,n){},"3f21":function(e,t,n){"use strict";n.r(t);var o=n("0136");for(var u in o)"default"!==u&&function(e){n.d(t,e,function(){return o[e]})}(u);n("cece");var a,c,r=n("2877"),l=Object(r["a"])(o["default"],a,c,!1,null,null,null);t["default"]=l.exports},cece:function(e,t,n){"use strict";var o=n("1a8c"),u=n.n(o);u.a}},[["086e","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push(['components/page-head-create-component', {
  'components/page-head-create-component': function componentsPageHeadCreateComponent(module, exports, __webpack_require__) {
    __webpack_require__('6e42')['createComponent'](__webpack_require__("96e2"));
  }
}, [['components/page-head-create-component']]]);
});
require('components/page-head.js');

__wxRoute = 'pages/tabBar/fe';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/tabBar/fe.js';

define('pages/tabBar/fe.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/tabBar/fe.js');
__wxRoute = 'pages/tabBar/native';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/tabBar/native.js';

define('pages/tabBar/native.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/tabBar/native.js');
__wxRoute = 'native/barcode/barcode';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/barcode/barcode.js';

define('native/barcode/barcode.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/barcode/barcode.js');
__wxRoute = 'pages/fe/button/button';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/button/button.js';

define('pages/fe/button/button.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/button/button.js');
__wxRoute = 'pages/fe/checkbox/checkbox';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/checkbox/checkbox.js';

define('pages/fe/checkbox/checkbox.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/checkbox/checkbox.js');
__wxRoute = 'pages/fe/radio/radio';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/radio/radio.js';

define('pages/fe/radio/radio.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/radio/radio.js');
__wxRoute = 'pages/fe/label/label';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/label/label.js';

define('pages/fe/label/label.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/label/label.js');
__wxRoute = 'pages/fe/form/form';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/form/form.js';

define('pages/fe/form/form.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/form/form.js');
__wxRoute = 'pages/fe/movable-view/movable-view';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/movable-view/movable-view.js';

define('pages/fe/movable-view/movable-view.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/movable-view/movable-view.js');
__wxRoute = 'pages/fe/swiper/swiper';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/swiper/swiper.js';

define('pages/fe/swiper/swiper.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/swiper/swiper.js');
__wxRoute = 'pages/fe/swiper-vertical/swiper-vertical';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/swiper-vertical/swiper-vertical.js';

define('pages/fe/swiper-vertical/swiper-vertical.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/swiper-vertical/swiper-vertical.js');
__wxRoute = 'pages/fe/scroll-view/scroll-view';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/scroll-view/scroll-view.js';

define('pages/fe/scroll-view/scroll-view.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/scroll-view/scroll-view.js');
__wxRoute = 'pages/fe/switch/switch';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/switch/switch.js';

define('pages/fe/switch/switch.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/switch/switch.js');
__wxRoute = 'pages/fe/slider/slider';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/slider/slider.js';

define('pages/fe/slider/slider.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/slider/slider.js');
__wxRoute = 'pages/fe/progress/progress';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/progress/progress.js';

define('pages/fe/progress/progress.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/progress/progress.js');
__wxRoute = 'pages/fe/navigator/index';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/navigator/index.js';

define('pages/fe/navigator/index.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/navigator/index.js');
__wxRoute = 'pages/fe/navigator/navigate';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/navigator/navigate.js';

define('pages/fe/navigator/navigate.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/navigator/navigate.js');
__wxRoute = 'pages/fe/navigator/redirect';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/navigator/redirect.js';

define('pages/fe/navigator/redirect.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/navigator/redirect.js');
__wxRoute = 'native/canvas/canvas';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/canvas/canvas.js';

define('native/canvas/canvas.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/canvas/canvas.js');
__wxRoute = 'native/canvas/webGL';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/canvas/webGL.js';

define('native/canvas/webGL.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/canvas/webGL.js');
__wxRoute = 'native/canvas/animation';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/canvas/animation.js';

define('native/canvas/animation.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/canvas/animation.js');
__wxRoute = 'native/cover-image/cover-image';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/cover-image/cover-image.js';

define('native/cover-image/cover-image.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/cover-image/cover-image.js');
__wxRoute = 'native/cover-view/cover-view';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/cover-view/cover-view.js';

define('native/cover-view/cover-view.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/cover-view/cover-view.js');
__wxRoute = 'native/live-pusher/live-pusher';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/live-pusher/live-pusher.js';

define('native/live-pusher/live-pusher.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/live-pusher/live-pusher.js');
__wxRoute = 'native/map/map';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/map/map.js';

define('native/map/map.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/map/map.js');
__wxRoute = 'native/map/mapsearch';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/map/mapsearch.js';

define('native/map/mapsearch.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/map/mapsearch.js');
__wxRoute = 'native/video/video';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/video/video.js';

define('native/video/video.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/video/video.js');
__wxRoute = 'native/faceID/faceID';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/faceID/faceID.js';

define('native/faceID/faceID.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/faceID/faceID.js');
__wxRoute = 'native/u-image/u-image';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/u-image/u-image.js';

define('native/u-image/u-image.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/u-image/u-image.js');
__wxRoute = 'native/u-input/u-input';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/u-input/u-input.js';

define('native/u-input/u-input.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/u-input/u-input.js');
__wxRoute = 'native/u-richtext/u-richtext';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/u-richtext/u-richtext.js';

define('native/u-richtext/u-richtext.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/u-richtext/u-richtext.js');
__wxRoute = 'native/u-text/u-text';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/u-text/u-text.js';

define('native/u-text/u-text.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/u-text/u-text.js');
__wxRoute = 'native/u-textarea/u-textarea';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/u-textarea/u-textarea.js';

define('native/u-textarea/u-textarea.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/u-textarea/u-textarea.js');
__wxRoute = 'native/u-webview/u-webview';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/u-webview/u-webview.js';

define('native/u-webview/u-webview.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/u-webview/u-webview.js');
__wxRoute = 'native/webSocket/webSocket';__wxRouteBegin = true;__wxAppCurrentFile__ = 'native/webSocket/webSocket.js';

define('native/webSocket/webSocket.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('native/webSocket/webSocket.js');
__wxRoute = 'pages/fe/lifecycle/lifecycle';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/lifecycle/lifecycle.js';

define('pages/fe/lifecycle/lifecycle.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/lifecycle/lifecycle.js');
__wxRoute = 'pages/fe/global/global';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/fe/global/global.js';

define('pages/fe/global/global.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/fe/global/global.js');
;(function(global) {
