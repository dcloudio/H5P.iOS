...
@interface DCHLBLEManager : NSObject
...
/** 蓝牙链接断开回调 **/
@property (copy, nonatomic) HLDisconnectBlock                       disconnectBlock;
 ...
 */
- (void)readValueForCharacteristic:(CBCharacteristic *)characteristic Peripheral:(CBPeripheral *)peripheral;
 ...
 */
- (void)readValueForCharacteristic:(CBCharacteristic *)characteristic Peripheral:(CBPeripheral *)peripheral completionBlock:(HLValueForCharacteristicBlock)completionBlock;
 ...
 */
- (void)readValueForDescriptor:(CBDescriptor *)descriptor Peripheral:(CBPeripheral *)peripheral completionBlock:(HLValueForDescriptorBlock)completionBlock;
