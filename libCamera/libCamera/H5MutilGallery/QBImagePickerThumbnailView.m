...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.emptyImage = [UIImage imageNamed:@"PandoraApi.bundle/plugin/gallery/emptyFolder.png"];
    }
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ( self.thumbnailImages.count > 0 ) {
        thumbnailImage = [self.thumbnailImages objectAtIndex:0];
    } else {
        thumbnailImage = self.emptyImage;
    }
    if ( thumbnailImage ) {
