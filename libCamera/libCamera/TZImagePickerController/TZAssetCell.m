...
@implementation DCTZAssetCell

- (void)setModel:(DCTZAssetModel *)model {
    _model = model;
    if (iOS8Later) {
...
- (DCTZProgressView *)progressView {
    if (_progressView == nil) {
        _progressView = [[DCTZProgressView alloc] init];
...
@interface DCTZAlbumCell ()
@property (weak, nonatomic) UIImageView *posterImageView;
@property (weak, nonatomic) UILabel *titleLabel;
@end

@implementation DCTZAlbumCell
...
- (void)setModel:(DCTZAlbumModel *)model {
    _model = model;
