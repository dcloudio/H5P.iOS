...
*/
#pragma mark -----------------------------------------------
@interface AMapPOI(JSOject)
-(NSString*)JSObject;
@end

@interface AMapGeoPoint(geoPoint)
...
@property(nonatomic,retain)MAPolyline *polyline;//路线的轨迹
...
+(PGGISRoute*)routeWithRoute:(AMapPath*)route;
+(PGGISRoute*)routeWithRoute:(AMapPath*)route withOrigin:(AMapGeoPoint*)origin withDest:(AMapGeoPoint*)destination;
...
+(PGGISBusline*)routeWithMABus:(AMapTransit*)bus;
@end
