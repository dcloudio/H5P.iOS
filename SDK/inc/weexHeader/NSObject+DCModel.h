 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `DCModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface DCAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation DCAuthor
     @end
 
     @interface DCBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) DCAuthor *author;
     @end
     @implementation DCBook
     @end
    
     int main() {
         // create model from json
         DCBook *book = [DCBook dc_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book dc_modelToJSONString];
 ...
 @code
     @interface DCShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation DCShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self dc_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self dc_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self dc_modelCopy]; }
     - (NSUInteger)hash { return [self dc_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self dc_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (DCModel)
 ...
 */
+ (nullable instancetype)dc_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)dc_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)dc_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)dc_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)dc_modelToJSONObject;
 ...
 */
- (nullable NSData *)dc_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)dc_modelToJSONString;
 ...
 */
- (void)dc_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)dc_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)dc_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (DCModel)
 ...
 */
+ (nullable NSDictionary *)dc_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<DCModel>' to your class header.
 */
@protocol DCModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class DCShadow, DCBorder, DCAttachment;
        ...
        @implementation DCAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [DCShadow class],
                     @"borders" : DCBorder.class,
...
/**
 ...
 Example:
 @code
        @class DCCircle, DCRectangle, DCLine;
 
        @implementation DCShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [DCCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [DCRectangle class];
